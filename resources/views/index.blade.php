...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="https://github.com/0xPurp">George Moula</a></h1>
      ...
      <nav class="nav-menu">
        <ul>
          <li class="active"><a href="#about"><i class="bx bx-home"></i> <span>Home</span></a></li>
          <li><a href="#about"><i class="bx bx-user"></i> <span>About</span></a></li>
          <li><a href="#skills"><i class="bx bx-atom"></i> Skills</a></li>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>0xPurp</span></strong>
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://github.com/0xPurp">0xPurp</a>
      </div>
    </div>
  </footer><!-- End  Footer -->
